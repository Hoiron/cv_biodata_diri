  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="coba.php">Fikri</a></h1>
          ...
          <form class="row g-3" action="" method="POST">
            <div class="row gx-3 mb-3">
              ...
              <div class="col-md-5" style="margin-left: 30px;">
                ...
                <input class="form-control" name="Tempat" value="" >
            ...
            <div class="row gx-3 mb-3">
              ...
              <div class="col-md-5" style="margin-left: 30px;">
                ...
                <input class="form-control" name="Alamat" value="" >
            ...
            <div class="row gx-3 mb-3">
              <div class="col-md-5" style="margin-left: 30px;">
                ...
                <input class="form-control" name="RT_RW" value="" >

              </div>
              <div class="col-md-5" style="margin-left: 30px;">
                <label class="small mb-1" style="font-weight: 900;">Kel/Desa :</label>
                <input class="form-control" name="Kel_Desa" value="" >
            ...
            <div class="row gx-3 mb-3">
              <div class="col-md-5" style="margin-left: 30px;">
                ...
                <input class="form-control" name="Kecamatan" value="" ></input>

              </div>
              <div class="col-md-5" style="margin-left: 30px;">
                <label class="small mb-1" style="font-weight: 900;">Agama :</label>
                <input class="form-control" name="Agama" value="" >
            ...
            <div class="row gx-3 mb-3">
              ...
              <div class="col-md-5" style="margin-left: 30px;">
                ...
                <input class="form-control" name="Pekerjaan" value="" >
            ...
            <div class="row gx-3 mb-3">
              <div class="col-md-5" style="margin-left: 30px;">
                ...
                <input class="form-control" name="Kewarganegaraan" value="" >
                ...
                <div class="card-body">
                  <div class="row gx-3 mb-3">
                    <div class="col-md-5" style="margin-left: 30px;">
                      ...
                      <input class="form-control" name="nama_keahlian1" value="" ></input>

                    </div>
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;">keterangan :</label>
                      <input class="form-control" name="keterangan1" value="" ></input>
                  ...
                  <div class="row gx-3 mb-3">
                    <div class="col-md-5" style="margin-left: 30px;">
                      ...
                      <input class="form-control" name="nama_keahlian2" value="" ></input>

                    </div>
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;"></label>
                      <input class="form-control" name="keterangan2" value="" ></input>
                  ...
                  <div class="row gx-3 mb-3">
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;"></label>
                      <input class="form-control" name="nama_keahlian3" value="" ></input>

                    </div>
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;"></label>
                      <input class="form-control" name="keterangan3" value="" ></input>
                ...
                <div class="card-body">
                  <div class="row gx-3 mb-3">
                    <div class="col-md-5" style="margin-left: 30px;">
                      ...
                      <input class="form-control" name="riwayat_pendidikan1" value="" ></input>

                    </div>
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;">nama pendidikan :</label>
                      <input class="form-control" name="nama_pendidikan1" value="" ></input>
                  ...
                  <div class="row gx-3 mb-3">
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;"></label>
                      <input class="form-control" name="riwayat_pendidikan2" value="" ></input>

                    </div>
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;"></label>
                      <input class="form-control" name="nama_pendidikan2" value="" ></input>
                  ...
                  <div class="row gx-3 mb-3">
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;"></label>
                      <input class="form-control" name="riwayat_pendidikan3" value="" ></input>

                    </div>
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;"></label>
                      <input class="form-control" name="nama_pendidikan3" value="" ></input>
                  ...
                  <div class="row gx-3 mb-3">
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;"></label>
                      <input class="form-control" name="riwayat_pendidikan4" value="" ></input>

                    </div>
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;"></label>
                      <input class="form-control" name="nama_pendidikan4" value="" ></input>
                  ...
                  <div class="row gx-3 mb-3">
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;"></label>
                      <input class="form-control" name="riwayat_pendidikan5" value="" ></input>

                    </div>
                    <div class="col-md-5" style="margin-left: 30px;">
                      <label class="small mb-1" style="font-weight: 900;"></label>
                      <input class="form-control" name="nama_pendidikan5" value="" ></input>
