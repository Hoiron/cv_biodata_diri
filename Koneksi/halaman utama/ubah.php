              ...
              <!-- <div class="col-xl-12"> -->
                ...
                <!-- Account card-->
                  ...
                  <div class="col" style="padding-left: 50px;">
                    <label class="small mb-1" style="font: 900;">nama keahlian :</label>
                    <?php for ($i =0; $i < sizeof($keahlian); $i++) { ?>
                      
                      <p><input type="hidden" class="form-control" style="backgraund-color: #bdc3c7;" name="id_keahlian[]" value="<?= $keahlian[$i]['id_keahlian']; ?>"></p>
                      <p><input type="from-control" style="backgraund-color: #bdc3c7;" name="nama_keahlian1[]" value="<?= $keahlian[$i]['nama_keahlian']; ?>"></p>
                      <?php } ?>
                    </div>
                  <div class="col" style="padding-left: 50px;">
                    <label class="small mb-1" style="font: 900;">keterangan :</label>
                    <?php for ($i =0; $i < sizeof($keahlian); $i++) { ?>
                      <p><input type="from-control" style="backgraund-color: #bdc3c7;" name="keterangan1[]" value="<?= $keahlian[$i]['keterangan']; ?>"></p>
                      <?php } ?>
                      </div>
                    </div>
...
<br><br><br><br>
                  ...
                  <div class="row">
                  <div class="col" style="padding-left: 50px;">
                    <label class="small mb-1" style="font: 900;"> riwayat_pendidikan :</label>
                    <?php for ($i =0; $i < sizeof($pendidikan); $i++) { ?>
                      
                      <p><input type="hidden" class="form-control" style="backgraund-color: #bdc3c7;" name="id_pendidikan[]" value="<?= $pendidikan[$i]['id_pendidikan']; ?>"></p>
                      <p><input type="from-control" style="backgraund-color: #bdc3c7;" name="riwayat_pendidikan1[]" value="<?= $pendidikan[$i]['riwayat_pendidikan']; ?>"></p>
                      <?php } ?>
                    </div>
                  <div class="col" style="padding-left: 50px;">
                    <label class="small mb-1" style="font: 900;">nama_pendidikan :</label>
                    <?php for ($i =0; $i < sizeof($pendidikan); $i++) { ?>
                      <p><input type="from-control" style="backgraund-color: #bdc3c7;" name="nama_pendidikan1[]" value="<?= $pendidikan[$i]['nama_pendidikan']; ?>"></p>
                      <?php } ?>
                      </div>
                    </div>
