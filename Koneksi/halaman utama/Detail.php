                                            ...
                                            <form>
                                                ...
                                                <div class="pertama">
                                                    <div class="row gx-3 mb-3">
                                                       ...
                                                       <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: green ;">Tempat</label>
                                                            <p><?= $m['Tempat']; ?></p>
                                                        </div>
                                                   ...
                                                   <div class="row gx-3 mb-3">
                                                        <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: red;">Tgl_lahir :</label>
                                                            <p><?= $m['Tgl_lahir']; ?></p>
                                                        </div>

                                                       <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: green ;">Jenis_Kelamin</label>
                                                            <p><?= $m['Jenis_Kelamin']; ?></p>
                                                        </div>
                                                        ...
                                                        <div class="row gx-3 mb-3">
                                                        <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: red;">Gol_Darah :</label>
                                                            <p><?= $m['Gol_Darah']; ?></p>
                                                        </div>

                                                       <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: green ;">Alamat</label>
                                                            <p><?= $m['Alamat']; ?></p>
                                                        </div>
                                                    ...
                                                    <div class="row gx-3 mb-3">
                                                        <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: red;">RT_RW :</label>
                                                            <p><?= $m['RT_RW']; ?></p>
                                                        </div>

                                                       <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: green ;">Kel_Desa</label>
                                                            <p><?= $m['Kel_Desa']; ?></p>
                                                        </div>
                                                    ...
                                                    <div class="row gx-3 mb-3">
                                                        <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: red;">Kecamatan:</label>
                                                            <p><?= $m['Kecamatan']; ?></p>
                                                        </div>

                                                       <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: green ;">Agama</label>
                                                            <p><?= $m['Agama']; ?></p>
                                                        </div>
                                                    ...
                                                    <div class="row gx-3 mb-3">
                                                        <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: red;">Status_Perkawinan :</label>
                                                            <p><?= $m['Status_Perkawinan']; ?></p>
                                                        </div>

                                                       <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: green ;">Pekerjaan</label>
                                                            <p><?= $m['Pekerjaan']; ?></p>
                                                        </div>
                                                        ...
                                                        <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: red;">Kewarganegaraan:</label>
                                                            <p><?= $m['Kewarganegaraan']; ?></p>
                                                        </div> 
                                                    </div>
                                                    <div class="row gx-3 mb-3">
                                                        <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: red;">nama_keahlian :</label>
                                                            <p><?= $m['nama_keahlian']; ?></p>
                                                        </div>

                                                       <div class="col-md-5" style="margin-left: 30px;">
                                                            <label class="small mb-1" style="font-weight: 900; color: green ;">Keterangan</label>
                                                            <p><?= $m['keterangan']; ?></p>
                                                        </div>
